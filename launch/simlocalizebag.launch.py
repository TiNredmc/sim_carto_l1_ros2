...
def generate_launch_description():
    ...
    # Configuration file
    configuration_basename = LaunchConfiguration('configuration_basename', default='R1_3D_localize.lua')
    ...
    cartographer_node = launch_ros.actions.Node(
        ...
        arguments=['-configuration_directory', configuration_directory,
                   ...
                   '-load_state_filename', os.path.join(get_package_share_directory(pkg_name), 'map', 'l1.pbstream'),
